...
<!--                <li><a href="SSS_toonshop/favorite-show.php">お気に入り</a></li>-->
			...
			<div class="width_controle text_center" role="main">	
					...
					if (!isset($_SESSION['customer'])) {
						echo '<p class="">購入手続きを行うにはログインしてください。</p>';
					} else 
					if (empty($_SESSION['product'])) {
						echo '<p class="">カートに商品がありません。</p>';
					} else {
						...
						require 'cart.php';
							...
							echo '<div style="height:120px; width:500px;" class="exact_box box2">';
						
									echo '<p style="margin:10px; font-size:1.2rem;">内容をご確認いただき、購入を確定してください。</p>';
									echo '<p style="margin:7px;" class="purchace_p">お名前：', $_SESSION['customer']['name'], '</p>';
									echo '<p style="margin:7px;" class="purchace_p">ご住所：', $_SESSION['customer']['address'], '</p>';
							echo '</div>';
						
						echo '<div';
						echo'<p  style="margin:50px 0px 50px 0px;"  class="btn_circle ">';
