		...
		<div>		
				<?php
					...
					if (!isset($_SESSION['customer'])) {
						echo '<p class="text_center">ログインをしてください</p>';
					} else 
					{
echo '<form class="center">';		
	...
	echo '<div class="customer_box">';		
					...
					echo '<span class="input_box_title">';
							echo'name';
						   echo'</span>';
						 echo '<p class="login_width">',$_SESSION['customer']['password'], '</p>';
						echo '</div>';
					...
					echo '<span class="input_box_title">';
							echo'friend-coad';
						   echo'</span>';
						 echo '<p class="nintendo_width">',$_SESSION['customer']['nintendo'], '</p>';
						echo '</div>';					
	 echo '</div>';	
...
echo '<div class="customer_box">';				
			...
			echo '<span class="input_box_title">';
					echo'rank';
				   echo'</span>';
		         echo '<p class="rank_width rank_size">',$_SESSION['customer']['rank'], '</p>';
				echo '</div>';
						...
						echo '<div class="customer_box">';	
										...
										echo '<div class="input_box udemae_box">';
												echo '<span class="input_box_title">';
													 echo'アサリ';
												   echo'</span>';
												 echo '<p class="udemae_width">',$_SESSION['customer']['game_a'], '</p>';
												echo '</div>';
												echo '</div>';
										...
										echo '<div class="input_box udemae_box">';
											echo '<span class="input_box_title">';
													echo'エリア';
												   echo'</span>';
												 echo '<p class="udemae_width">',$_SESSION['customer']['game_e'], '</p>';
												echo '</div>';
												echo '</div>';
										...
										echo '<div class="input_box udemae_box">';
											echo '<span class="input_box_title">';
													echo'ホコ';
												   echo'</span>';
												 echo '<p class="udemae_width">',$_SESSION['customer']['game_h'], '</p>';
												echo '</div>';
												echo '</div>';
						               ...
						               echo '<div>';
										echo '<div class="input_box udemae_box right_none">';
											echo '<span class="input_box_title">';
													echo'ヤグラ';
												   echo'</span>';
												 echo '<p class="udemae_width">',$_SESSION['customer']['game_y'], '</p>';
												echo '</div>';
												echo '</div>';
	...
	echo '</div>';			
						...
						echo'<div>';
		echo '<div class="input_box memo_width memo_width_my_page">';
		echo '<span class="input_box_title">';
					echo 'memo';
				    echo'</span>';
						echo '<p>';
...
//							echo '<a href="picture_update.php">Up-load</a>';
