...
<div  class="log_in width_controle" role="main">
		
	<div  class="sub_box">
		<form class="text_center login_form"action="login-output.php" method="post">
		<p><span class="sub_box_text_name">name</span><span class="sub_box_input input_box"><input type="text" class="login_input" placeholder="ログイン名" name="login"></span></p>
		<p><span class="sub_box_text_pass">password</span><span class="sub_box_input input_box"><input type="password" class="login_input" placeholder="パスワード"  name="password"></span></p>
		<p class="btn_circle"><input class="submit" type="submit" value="Login"></p>
		</form>
	</div>
</div>
